...
// Abre una ventana con un formato limpio y lanza el di├ílogo de impresi├│n del
// navegador; desde ah├¡ el usuario elige "Guardar como PDF".
// ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
...
// m├ís tarde (p. ej. despu├®s de un fetch). Muestra un aviso de "generando".
function nuevaVentanaPDF() {
  const win = window.open('', '_blank', 'width=900,height=700');
  if (win) {
    win.document.write('<!DOCTYPE html><html lang="es"><head><meta charset="utf-8">' +
      '<title>Generando documentoÔÇª</title></head>' +
      '<body style="font-family:\'Segoe UI\',Arial,sans-serif;color:#555;padding:48px;">' +
      'Generando documentoÔÇª</body></html>');
  }
  return win;
}

// Escribe el documento final en la ventana ya abierta y lanza el di├ílogo de impresi├│n.
function escribirImpresionPDF(win, titulo, cuerpoHTML) {
  if (!win) {
    alert('Tu navegador bloque├│ la ventana de impresi├│n. Permite las ventanas emergentes para generar el PDF.');
    return;
  }
...
<body>
  ...
  ${cuerpoHTML}
  <div class="pie">Documento generado por el Sistema de Gesti├│n ÔÇö Constructora</div>
